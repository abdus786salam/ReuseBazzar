...
export default class Responsive extends Component {
  render() {
    ...
    return (
      <>
      <div style={{width:"80%",margin:"auto",marginTop:"30px",backgroundColor:"white"}}>
       <p style={{fontSize:"20px"}}>Trendind Ads</p>
        ...
        >
            ...
            {data.map((el,i)=>{
                ...
                return<div key={i+1}style={{border:"9px solid blue"}}><img style={{width:"70%",height:"180px"}}src={el.img}/>
